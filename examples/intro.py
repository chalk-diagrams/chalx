...
print("svg")
d = triangle(1).fill_color(papaya)
...
@jax.vmap
def c(s) -> Diagram:
    return triangle(1).scale(s).fill_color(papaya)
...
d = circle(0.5).fill_color(papaya) | triangle(1).fill_color(blue) | square(1).fill_color(papaya)
print("mpl")
d.render_mpl(path, height=64)
#exit()
